...
| Model | File | Download |
|-------|------|----------|
| CLIP ViT-L/14 (Standard) | `clip_finetuned_0827.torchscript` | Google Drive |
| CLIP ViT-L/14 (Sensitive) | `clip_finetuned.torchscript` | Google Drive |
| SiGLIP ViT | `image_deepfake_detector_best/` | Google Drive |
| WavLM Base+ | `wavlm-deepfake-detector-final/` | Google Drive |
